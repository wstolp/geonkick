/**
 * File name: RkContainerLgWidgetItem.h
...
#ifndef RK_CONTAINER_LGWIDGET_ITEM_H
#define RK_CONTAINER_LGWIDGET_ITEM_H

#include <RkContainerItem.h>

class LgWidget;

class RkContainerLgWidgetItem: public RkContainerItem {
 public:
       RkContainerLgWidgetItem(LgWidget *parent,
                            Rk::Alignment align = Rk::Alignment::AlignLeft)
                 : RkContainerItem(parent, ItemType::ItemContainer, align)
                   , itemWidget{parent} {}
        virtual ~RkContainerLgWidgetItem() = default;
        ...
        LgWidget* widget() const { return itemWidget; }
        void hide(bool b) override { return b ? itemWidget->hide() : itemWidget->show(); }
        bool isHidden() const override { return !itemWidget->isShown(); }

 private:
        RK_DISABLE_COPY(RkContainerLgWidgetItem);
        RK_DISABLE_MOVE(RkContainerLgWidgetItem);
        RkSize itemSize;
        LgWidget *itemWidget;
};

#endif // RK_CONTAINER_LGWIDGET_ITEM_H
