/**
 * File name: PresetMetadataWidget.h
...
#ifndef PRESET_METADATA_WIDGET_H
#define PRESET_METADATA_WIDGET_H

#include "geonkick_widget.h"

class PresetMetadataWidget: public GeonkickWidget
{
 public:
    PresetMetadataWidget(GeonkickWidget *parent,
    KitModel* model,
